...
import { elapsedAsString } from '../../utils'
...
const divStyle = {}
function MapaPersonas({ mediciones }: Props) {
  if (mediciones.length === 0) return <Centered>Cargando...</Centered>
  const [medicionActual, setMedicionActual] = useState<
    MedicionGPS | undefined
  >()
...
export default React.memo(MapaPersonas)
